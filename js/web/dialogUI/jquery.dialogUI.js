...
//title_confirm: "\u6e29\u99a8\u63d0\u793a",
	...
	g.alert = function(t, r, q, p,ht) {
		...
		var o = m({
			...
			title: r,
			msg: t,
			bt_text: '<input type="button" value="' + g.blockUI_lang.button_sure + '" id="alert_close_button" class="buttonMain" />'
		});
		$html = g(o);
		g.blockUI({
			message: $html,
...
//			bt_text: '<input type="button" value="' + g.blockUI_lang.button_sure + '" id="confirm_yes" width="50%" height="43" align="center" class="submit" />&nbsp;&nbsp;<input type="button" value="' + g.blockUI_lang.button_cancel + '" id="confirm_no" class="cancel" />'
			bt_text: '<input type="button" value="' + g.blockUI_lang.button_sure + '" id="confirm_yes" width="50%" height="43" align="center" class="buttonMain" />&nbsp;&nbsp;<input type="button" value="' + g.blockUI_lang.button_cancel + '" id="confirm_no" class="buttonSec" />'
		});
		$html = g(p);
		g.blockUI({
			message: $html,
